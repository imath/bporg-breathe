...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-meta">
			<?php if ( ! is_page() ) :
				$author_posts_url = get_author_posts_url( get_the_author_meta( 'ID' ) );
					...
					__( 'Posts by %1$s ( @%2$s )', 'bporg-breathe' ),
			...
			<?php if ( is_object_in_taxonomy( get_post_type(), 'post_tag' ) ) : ?>
				<span class="entry-tags">
					<?php breathe_tags_with_count( '', '<br />' . __( 'Tags:' , 'bporg-breathe' ) .' ', ', ', ' &nbsp;' ); ?>&nbsp;
				</span>
			<?php endif; ?>
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'bporg-breathe' ) ); ?>
		<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'bporg-breathe' ), 'after' => '</div>' ) ); ?>
	</div><!-- .entry-content -->
	<?php endif; ?>
